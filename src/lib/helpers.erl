...
populate_test_data() ->
    ...
    {ok,SG1} = G:save(),
    I = image:new(id,"first image",slug,"description",{{2012,2,25},{23,20,9}},"medium","1d3964dfd1664247fef81c265dedd7a4c040eb3a",".jpg"),
    {ok,SI1} = I:save(),
    I2 = image:new(id,"second image",slug,"description",{{2012,2,25},{23,20,9}},"medium","477da14b4128da9e94677d5a61e786874484cd12",".jpg"),
    {ok,SI2} = I2:save(),
